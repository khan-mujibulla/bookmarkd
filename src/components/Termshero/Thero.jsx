...
const Thero = () => {
  ...
  return (
    <div className="relative min-h-[90vh] bg-gradient-to-br from-[#4F46E5]/5 via-white to-[#A78BFA]/5 overflow-hidden">
      <div className="absolute inset-0">
        {Array.from({ length: 30 }).map((_, i) => (
          <div
            key={i}
            className="absolute rounded-full bg-gradient-to-r from-[#4F46E5]/20 to-[#A78BFA]/20"
            style={{
        ...
        <div className="absolute bottom-1/4 -right-32 w-96 h-96 bg-[#A78BFA]/20 rounded-full blur-3xl"></div>
      </div>
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <div className="flex justify-center">
                <div className="w-20 h-20 bg-gradient-to-br from-[#4F46E5] to-[#A78BFA] rounded-2xl flex items-center justify-center shadow-xl">
                  <svg
              ...
              <div className="flex flex-wrap justify-center gap-8 pt-8">
                <div className="text-center">
                  <div className="text-3xl font-bold text-[#4F46E5]">Usage</div>
                  <div className="text-sm text-[#6B7280] mt-1">Guidelines</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-[#4F46E5]">User</div>
                  <div className="text-sm text-[#6B7280] mt-1">Rights</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-[#4F46E5]">Legal</div>
                  <div className="text-sm text-[#6B7280] mt-1">Compliance</div>
                </div>
              </div>
