          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <div className="flex justify-center">
                <div className="w-20 h-20 bg-gradient-to-br from-indigo-500 to-purple-500 rounded-2xl flex items-center justify-center shadow-2xl">
                  <svg
              ...
              <div className="flex flex-wrap justify-center gap-8 pt-8">
                <div className="text-center">
                  <div className="text-3xl font-bold text-white">Usage</div>
                  <div className="text-sm text-amber-300 mt-1">Guidelines</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-white">User</div>
                  <div className="text-sm text-amber-300 mt-1">Rights</div>
                </div>
                <div className="text-center">
                  <div className="text-3xl font-bold text-white">Legal</div>
                  <div className="text-sm text-amber-300 mt-1">Compliance</div>
                </div>
              </div>
